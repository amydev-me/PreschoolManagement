<div class="tab-pane active" id="account_detail">
    <form class="form-horizontal  animated bounceInRight"  role="form" @submit.prevent="validateData('account-form')" data-vv-scope="account-form">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="username" v-model="student.username" name="username" v-validate="'required|verify_user'" placeholder="Enter User Name">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <input type="password" class="form-control" id="password"  v-model="student.password" name="password" v-validate="'required'" placeholder="Enter Password">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <input v-validate="'required|confirmed:password'" id="confirm_password" name="password_confirmation" type="password" class="form-control" placeholder="Confirm password" data-vv-as="password" placeholder="Enter Confirm Password">
