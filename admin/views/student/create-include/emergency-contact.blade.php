<div class="tab-pane edit-tab" id="em_tab" >
    <form class="form-horizontal  animated bounceInRight"  @submit.prevent="validateData('emergency_form')" data-vv-scope="emergency_form" autocomplete="off">
        <div class="form-group">
            ...
            <div v-show="errors.has('emergency_form.em_name')"><span class="error">@{{ errors.first('emergency_form.em_name') }}</span></div>
        </div>
        ...
        <div class="form-group">
            ...
            <div v-show="errors.has('emergency_form.em_relation')"><span class="error">@{{ errors.first('emergency_form.em_relation') }}</span></div>
        </div>
        ...
        <div class="form-group">
            ...
            <div v-show="errors.has('emergency_form.em_contact')"><span class="error">@{{ errors.first('emergency_form.em_contact') }}</span></div>
        </div>
