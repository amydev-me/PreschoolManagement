<div class="tab-pane fade animated bounceInRight" id="employee_detail">
    <form class="form-horizontal"  @submit.prevent="validateData('employee_form')" data-vv-scope="employee_form" autocomplete="off">
